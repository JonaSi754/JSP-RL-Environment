...
import numpy as np
import gym
from envs.JSP_v5_random_mod import env as make, make_env
...
def get_args(env):
    ...
    parser.add_argument('--env_name',default='JSP-v5-random-mode',type=str,help="name of environment")
...
model = PPO('MlpPolicy', env=env, learning_rate=cfg.lr, n_steps=cfg.n_steps, batch_size=25, device=cfg.device, tensorboard_log=cfg.tensorboard_log)
...
print(f"Min makespan got from PPO is: {min_makespan}")
# plt.show()
