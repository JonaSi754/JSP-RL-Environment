...
model = DDPG('MlpPolicy', env=env, learning_rate=cfg.lr, batch_size=25, device=cfg.device, buffer_size=100000, learning_starts=cfg.n_steps)
...
print(f"Min makespan got from DDPG is: {min_makespan}")
# plt.show()
