...
def get_args(env):
    ...
    parser.add_argument('--env_name',default='JSP-v5',type=str,help="name of environment")
    parser.add_argument('--n_envs',default=10,type=int,help="numbers of environments")
    parser.add_argument('--n_sample', default=2000,type=int,help="num of sample points")
...
model = A2C('MlpPolicy', env=env, learning_rate=cfg.lr, device=cfg.device, n_steps=cfg.n_steps)
