...
def read_JSP(Instance_name):
    if 'abz' in Instance_name:
        file_path = "/home/sssjh/Workspace/MyRL/Input/JSP/abz/" + Instance_name + '.txt'
    elif 'cscmax' in Instance_name:
        file_path = "/home/sssjh/Workspace/MyRL/Input/JSP/cscmax/" + Instance_name + '.txt'
    elif 'ft' in Instance_name:
        file_path = "/home/sssjh/Workspace/MyRL/Input/JSP/ft/" + Instance_name + '.txt'
    elif 'la' in Instance_name:
        file_path = "/home/sssjh/Workspace/MyRL/Input/JSP/la/" + Instance_name + '.txt'
    elif 'orb' in Instance_name:
        file_path = "/home/sssjh/Workspace/MyRL/Input/JSP/orb/" + Instance_name + '.txt'
    elif 'rcmax' in Instance_name:
        file_path = "/home/sssjh/Workspace/MyRL/Input/JSP/rcmax/" + Instance_name + '.txt'
    elif 'ta' in Instance_name:
        file_path = "/home/sssjh/Workspace/MyRL/Input/JSP/ta/" + Instance_name + '.txt'
    else:
